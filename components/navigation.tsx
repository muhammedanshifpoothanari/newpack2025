...
<nav className="h-20 flex items-center px-4">
  <Link href="/" className="flex items-center">
    <img
      ...
      alt="NewPack"
      className="h-16 w-auto scale-250"
    />
  </Link>
</nav>
            ...
            <div className="hidden lg:flex items-center gap-8">
              <Link
                ...
                className={`text-sm font-medium transition-colors ${
                  isActive("/products") ? "text-primary font-semibold" : "text-foreground hover:text-primary"
                }`}
              >
                Products
              </Link>
              <Link
                href="/solutions"
                className={`text-sm font-medium transition-colors ${
                  isActive("/solutions") ? "text-primary font-semibold" : "text-foreground hover:text-primary"
                }`}
              >
                Solutions
              </Link>
